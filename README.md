...
| :--- | :---: | :---: | :--- |
| 🎧 Podcast Player | v1.0 | ✅ Stable | PodcastIndex + RSS, Whisper transcription, CEFR subtitles, word lookup, cloud sync |
...
| 🗂 Deck Hub | v1.0-beta | 🧪 Beta | Create flashcard decks from text or images using AI; export to Anki `.apkg` |
